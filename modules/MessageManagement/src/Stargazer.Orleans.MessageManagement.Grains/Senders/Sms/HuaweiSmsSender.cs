...
public class HuaweiSmsSender(HuaweiSmsSettings settings, ILogger<HuaweiSmsSender> logger)
    : ISmsSender
{
    private readonly HuaweiSmsSettings _settings = settings ?? throw new ArgumentNullException(nameof(settings));
    private readonly ILogger<HuaweiSmsSender> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogWarning("Huawei SMS not configured - stub implementation");
